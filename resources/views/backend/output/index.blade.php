        ...
        <table class="table table-bordered table-striped table-hover">
            <tbody>
                <tr>
                  ...
                  <tr>
                    <th>{{ $sub->nama }}</th>
                    <th><?php echo number_format($sub->anggaran/1000,0,",","."); ?></th>
                    <th>{{ $sub->kinerja }}</th>
                    <th><?php echo number_format($sub->januari/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->februari/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->maret/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->april/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->mei/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->juni/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->juli/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->agustus/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->september/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->oktober/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->november/1000,0,",","."); ?></th>
                    <th><?php echo number_format($sub->desember/1000,0,",","."); ?></th>
                    <th>{{ $sub->capaian }}</th>
                    <th>{{ $sub->unit }}</th>
                    <th>
...
<div class="modal fade" id="tambahmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="{{ URL::to('admin/output/storesub/'.$id) }} " method="post">
...
<div class="modal fade" id="editsuboutput{{ $sub->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form class="form-horizontal" action="{{ URL::to('admin/output/updatesub/'.$sub->id.'/'.$id) }} " method="post">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="box-body">
           <div class="form-group">
              <label for="inputEmail3" class="col-sm-3 control-label">Nama</label>
